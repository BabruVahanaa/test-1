                ...
                <div className="w-full max-w-md mx-auto">
                    <div className="text-right mb-8">
                        <p className="text-sm text-protribe-gray-dark">
                            Don't have an account? <Link to="/signup" className="font-medium text-protribe-teal hover:underline">Sign Up</Link>
                        </p>
                    </div>
                    <h2 className="text-3xl font-bold text-protribe-gray-extradark mb-2">Welcome Back!</h2>
                    <p className="text-protribe-gray-dark mb-8">Sign in to manage your coaching business.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className="flex justify-between">
                                ...
                                <a href="#" className="text-sm text-protribe-teal hover:underline">Forgot password?</a>
                            </div>
